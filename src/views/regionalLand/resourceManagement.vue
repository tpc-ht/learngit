    ...
    <div style="padding:20px;">
            ...
            <ul>
                ...
                <li>
                    ...
                    <div class="inputes">
                        ...
                        <el-select v-model="unitValue" clearable placeholder="选择单位" style="width: 105px!important;">
                ...
                <li>
                    <el-row class="inputes">
                        <el-button @click="toAddLand()">添加土地资源</el-button>
                    </el-row>
                </li>
            </ul>
        </div>
        ...
        <div>
            ...
            <el-table :data="tableData.list" border style="width: 100%">
                ...
                <el-table-column prop="id_card_number" label="预约带看费" width="220">
                </el-table-column>
                <el-table-column prop="real_name" label="发布人" width="120">
                </el-table-column>
                <el-table-column prop="phone" label="联系电话" width="120">
                </el-table-column>
                <el-table-column prop="proxy_money" label="审批状态" width="100">
                    <template slot-scope="scope">
                        <span>￥{{scope.row.proxy_money}}</span>
                    </template>
                </el-table-column>
                <el-table-column prop="earnest_money" label="土地状态" width="100">
                    <template slot-scope="scope">
                ...
                <el-table-column label="操作" width="200">
                    <template slot-scope="scope">
                        ...
                        <el-button @click="contentClick(scope)" type="text" size="small">重新上架</el-button>
                    </template>
                </el-table-column>
            </el-table>
        </div>
