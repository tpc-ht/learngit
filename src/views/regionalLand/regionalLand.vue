    ...
    <div style="padding:20px;">
        ...
        <div>
            ...
            <el-table :data="tableData.list" border style="width: 100%">
                ...
                <el-table-column prop="typeid" label="金额" width="80">
                ...
                <el-table-column prop="level" label="标题" width="100">
                    <template slot-scope="scope">
                ...
                <el-table-column prop="end_time" label="备注" width="120">
                </el-table-column>
                ...
                <el-table-column prop="proxy_payed" label="是否成交" width="100">
                    <template slot-scope="scope">
    ...
    export default {
        ...
        methods: {
            ...
            contentClick(scope) { //合同
              this.$router.push({path: '/markingDetails',query:{}})
            },
            passClick(row, e) { //通过
                var dtas = row;
                var el = e.target;
