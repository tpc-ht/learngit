    ...
    <div style="padding:20px;">
        <div class="head-ed">
            <ul>
                ...
                <li style="float: right;line-height: 36px;margin: 15px 15px 0 0;">
                    <span class="sp-df">最新</span>
                    <span class="sp-df">最旧</span>
                </li>
            </ul>
        </div>
        ...
        <div>
            ...
            <el-table :data="tableData.list" border style="width: 100%">
                <el-table-column prop="id_card_number" label="发布时间" width="220">
                </el-table-column>
                <el-table-column prop="agent_create_time" label="类型" width="150">
                </el-table-column>
                <el-table-column prop="real_name" label="发布人" width="120">
                </el-table-column>
                <el-table-column prop="phone" label="联系电话" width="120">
                </el-table-column>

                <el-table-column prop="card_address" label="所在位置" width="300">
                </el-table-column>
                <el-table-column prop="proxy_region" label="面积" width="300">
                </el-table-column>
                <el-table-column prop="proxy_region" label="付款方式" width="300">
                </el-table-column>
                <el-table-column prop="proxy_region" label="土地年限" width="300">
                </el-table-column>
                <el-table-column prop="typeid" label="出租价格" width="80">
                ...
                <el-table-column prop="earnest_money" label="用户等级" width="100">
                    <template slot-scope="scope">
                        <span>￥{{scope.row.earnest_money}}</span>
                    </template>
                </el-table-column>
                <el-table-column prop="proxy_payed" label="是否合作" width="100">
                    <template slot-scope="scope">
                ...
                <el-table-column label="操作" width="50">
                    <template slot-scope="scope">
                        <el-button @click="contentClick(scope)" type="text" size="small">标记</el-button>
                    </template>
                </el-table-column>
            </el-table>
        </div>
    ...
    export default {
        ...
        methods: {
            ...
            contentClick(scope) { //合同
                this.$router.push({path: '/externalLandInformation',query:{}})
            },
            passClick(row, e) { //通过
                var dtas = row;
                var el = e.target;
